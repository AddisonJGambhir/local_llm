#!/usr/bin/env bash
# TEXT-ONLY variant of the tuned ROCm preset for Qwen3.6 35B-A3B Q8_0.
# Identical tuning, minus the vision projector.
#
# Measured 2026-08-16 (decode with a fixed seed, prefill through Pi):
#   this profile      83.23 t/s decode   2538 t/s prefill   XTX peak 23543 MiB
#   with vision       81.46 t/s decode   2511 t/s prefill
#
...
PROFILE_NAME="preset-36-35b-a3b-q8-mtp-rocm-dual-f16-256k-textonly"
