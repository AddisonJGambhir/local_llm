...
| debug/validation | N/A | `VULKAN_DEBUG/VALIDATE/CHECK_RESULTS` all **OFF** |
...
| --- | ---: | ---: | --- |
| `vulkan-base` (no DFlash) | 262.11 | **38.20** | N/A |
| `vulkan-dflash` n-max=15 | 239.72 | **31.86** | **−17 %** |
| `rocm-base` (no DFlash) | 145.37 | 32.01 | N/A |
...
| vulkan, no DFlash | 192 | N/A | 289.87 | 37.92 | N/A |
| rocm | 512 | 15 | 124.27 | 44.45 | 0.117 |
| rocm *(original)* | 192 | 15 | 125.07 | 45.84 | 0.123 |
| rocm, no DFlash | 192 | N/A | 145.37 | 32.01 | N/A |
...
| vs. ROCm best (44.45 t/s) | 0.56× | **1.64×** | N/A |
